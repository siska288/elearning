        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Tambah Data Tugas</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.php" class="breadcrumb-link">Home</a></li>
                                        <li class="breadcrumb-item"><a href="edit_guru.php" class="breadcrumb-link">Tambah Data Tugas</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Input Data Tugas</h5>
                                <div class="card-body">
                                    <?php
                                            include '../koneksi/koneksi.php';
                                    ...
                                    <form action="proses_tugas.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="judul" type="text" placeholder="Masukkan Nama Guru" class="form-control">
                                        </div>
                                          <div class="form-group">
                                            <label for="inputnama">Deskripsi</label>
                                            <input name="deskripsi" type="text" placeholder="Masukkan Nama Guru" class="form-control">
                                        </div>
                                          <div class="form-group">
                                            <label for="inputnama">Batas Pengumpulan</label>
                                              ...
                                              <input placeholder="Masukkan Batas Tugas" type="text" class="form-control datepicker" name="batastugas">
                                            </div>
                                        </div>
                                         <?php
                                            include '../koneksi/koneksi.php';
