                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="tambah_kelas.php" class="breadcrumb-link">Tambah Data kelas</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <form action="proses_kelas.php" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control date-inputmask" name="nama_kelas" placeholder="">
                                </div> 
